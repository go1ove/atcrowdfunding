...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            <div><a class="navbar-brand" href="${pageContext.request.contextPath }/index.htm" style="font-size:32px;">尚筹网-创意产品众筹平台</a></div>
        </div>
    </div>
</nav>
    ...
    <form class="form-signin" role="form">
        ...
        <div class="checkbox">
            ...
            <label style="float:right">
                <a href="${pageContext.request.contextPath }/login.htm">我有账号</a>
            </label>
        </div>
        <a class="btn btn-lg btn-success btn-block" href="${pageContext.request.contextPath }/member.htm" > 注册</a>
    </form>
</div>
